...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h2 class="mb-2 fw-bold">Welcome, <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h2>
            <p class="text-muted">
                You logged in: <?php echo e($user->last_login_at?->format('M j, Y g:i a') ?? 'First login'); ?>. Hope you have a nice day.
            </p>
        </div>
    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 shadow-lg h-100">
                <div class="card-body p-4 text-center">
                    ...
                    <p class="display-4 fw-bold text-primary mb-2"><?php echo e($stats['total_patients'] ?? 0); ?></p>
                ...
                <div class="card-body p-4 text-center">
                    ...
                    <h5 class="card-title text-dark mb-3">
                        ...
                        <?php elseif($user->isDoctor()): ?>
                            My Tasks
                        <?php elseif($user->isNurse()): ?>
                            Assigned Tasks
                        <?php endif; ?>
                    </h5>
                    <p class="display-4 fw-bold text-info mb-2"><?php echo e($stats['total_tasks'] ?? 0); ?></p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <p class="display-4 fw-bold text-success mb-2"><?php echo e($stats['my_patients'] ?? 0); ?></p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <p class="display-4 fw-bold text-warning mb-2"><?php echo e($stats['assigned_patients'] ?? 0); ?></p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body p-4 text-center">
                        ...
                        <p class="display-4 fw-bold text-dark mb-2"><?php echo e($stats['total_staff'] ?? 0); ?></p>
    ...
    <script>
        ...
        const appointmentChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($stats['scheduled_appointments'] ?? 0); ?>,
                        <?php echo e($stats['completed_appointments'] ?? 0); ?>,
                        <?php echo e($stats['cancelled_appointments'] ?? 0); ?>,
                        <?php echo e($stats['rescheduled_appointments'] ?? 0); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\healthcare-system\resources\views/home.blade.php ENDPATH**/ ?>