...
<div class="profile-image-wrapper text-center mb-4">
    <div class="avatar-container mx-auto">
        <img src="<?php echo e($profileImage); ?>"
             class="profile-image"
             alt="<?php echo e($user->name); ?>'s Profile"
    ...
    <div class="profile-name-container mt-3">
        <h4 class="mb-1"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4>
        <div class="role-badge"><?php echo e(ucfirst($user->role)); ?></div>
    </div>
</div>
                        ...
                        <div class="col-md-8">
                            <div class="profile-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value"><?php echo e($user->phone ?? 'Not provided'); ?></span>
                                </div>
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">
                                        <?php if($user->date_of_birth): ?>
                                            <?php echo e(\Carbon\Carbon::parse($user->date_of_birth)->format('F j, Y')); ?>
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value"><?php echo e($user->address ?? 'Not provided'); ?></span>
                                </div>

                                <?php if($user->license_number): ?>
                                <div class="detail-item">
                                    <span class="detail-label">License Number</span>
                                    <span class="detail-value"><?php echo e($user->license_number); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\healthcare-system\resources\views/profile/show.blade.php ENDPATH**/ ?>