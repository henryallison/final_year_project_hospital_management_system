                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="weight" class="form-control @error('weight') is-invalid @enderror"
                               value="{{ old('weight') }}" min="2" max="300" step="0.1">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="chronic_conditions" class="form-control @error('chronic_conditions') is-invalid @enderror" rows="3">{{ old('chronic_conditions') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="family_medical_history" class="form-control @error('family_medical_history') is-invalid @enderror" rows="3">{{ old('family_medical_history') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="medical_history" class="form-control @error('medical_history') is-invalid @enderror" rows="2">{{ old('medical_history') }}</textarea>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="current_medications" class="form-control @error('current_medications') is-invalid @enderror" rows="2">{{ old('current_medications') }}</textarea>
